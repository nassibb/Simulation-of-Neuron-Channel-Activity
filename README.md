## Hodgkin Huxley Neuronal Firing Model

This notebook implements a Hodgkin Huxley  neuron model to study voltage-dependent ion channel behavior and action potential formation. The system is solved using multiple numerical integration techniques (Euler, RK2, RK4) to analyze tradeoffs between computational efficiency and numerical accuracy during fast nonlinear voltage dynamics.
